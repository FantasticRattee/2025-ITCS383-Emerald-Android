...
The objective of this report is to demonstrate measurable improvement in software quality between the previous code state (as documented in the original D2 report by team Arai-Kor-Dai) and the current improved state produced by Team Emerald, supported by concrete metrics extracted from SonarCloud analysis results.
...
The previous quality report by team Arai-Kor-Dai indicated that the project passed the SonarCloud Quality Gate with the following recorded metrics:

- **Quality Gate Status:** Passed
- **Blocker Issues:** 0
- **High Severity Issues:** 0
- **Code Smells:** 17 (Critical: 8, Major: 5, Minor: 4)
...
4. **No detailed issue categorization** — The report did not fully distinguish between bugs, vulnerabilities, and code smells, limiting the depth of quality assessment.
5. **Outstanding code smells** — 17 code smell issues (8 Critical, 5 Major, 4 Minor) remained unresolved, posing a risk to long-term maintainability.

### Before Screenshot
<img width="1051" height="531" alt="image" src="https://github.com/user-attachments/assets/35f6a222-d894-49eb-a7f4-5f1b5562e1fd" />

<img width="1020" height="530" alt="image" src="https://github.com/user-attachments/assets/20b18abc-3354-4fae-99aa-418ab726005a" />

<img width="1051" height="531" alt="image" src="https://github.com/user-attachments/assets/31245a70-6fba-4751-bace-65b074e139e9" />
...
Between the old and new analyses, Team Emerald implemented the following technical improvements:

### 3.1 Unit Test Implementation

Comprehensive unit tests were added to the project, achieving **95.1% code coverage** across 262 lines to cover. This represents a significant investment in test quality, as the previous iteration had no recorded coverage data. The coverage increase of +10.7% over the last 30 days indicates ongoing and active test development.
...
### 3.5 Code Smell Resolution Evidence
...
A total of **17 code smell issues** identified in the earlier analysis have now been fully resolved. These issues were distributed across multiple severity levels:
...
The latest SonarCloud analysis of the **PostOfficeApp Android** project shows the following results:
...
<img width="1676" height="886" alt="image" src="https://github.com/user-attachments/assets/f5726973-260f-4c20-9d44-04ccf326abef" />
...
| Code Smells            | 17            | 0             | ✅ Reduced by 17 (100% fixed) |
...
1. **Code smells fully resolved** — 17 outstanding issues (Critical, Major, Minor) from the old analysis were all fixed, directly improving maintainability.
2. **Coverage visibility** — going from untracked to 95.1% demonstrates a mature and disciplined testing practice.
3. **Zero issues across all categories** confirms that the codebase is clean and well-maintained.
4. **Full metric tracking** in the new analysis provides a far more complete and actionable quality picture compared to the limited old report.
...
The SonarCloud analysis demonstrates that the **PostOfficeApp Android** project has achieved a high standard of software quality under Team Emerald's improvements:

- **All quality ratings are A** across security, reliability, and maintainability.
- **All 17 code smells** (8 Critical, 5 Major, 4 Minor) from the previous analysis have been fully resolved.
...
Compared to the previous report, the most impactful improvements are the complete resolution of all identified code smells and the introduction of comprehensive metric tracking — particularly coverage and duplication — which provides a transparent and complete view of code health. The integration of GitHub Actions ensures that these quality standards are maintained continuously as the project evolves.

The project meets and exceeds the required code quality standards for the D2 deliverable.
