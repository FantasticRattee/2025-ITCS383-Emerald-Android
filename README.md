...
> A native Android application that allows customers to prepare parcels and letters before visiting the post office — register, create shipments, pay online, and track deliveries right from their mobile devicessss.
